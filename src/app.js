...
const ApplySec = require("./models/applySec");
...
app.post("/complaint" , async(req,res) =>{
   ...
   app.post("/applySec" , async(req,res) =>{
    try{  
     const AddData = new ApplySec(req.body);
     const registered = await AddData.save();
     console(req.body);  
...
app.post("/applyCourse" , async(req,res) =>{
    try{  
     const AddData = new applyCourse(req.body);
     const registered = await AddData.save();
     console(req.body);  
    } 
    catch(e)   
